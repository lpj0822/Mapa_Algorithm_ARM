...
File name: Classement_Zone.c
Version: 1.0		Date: 2017-04-28		Author: Yanming Wang		ID: 1047930

Description:
	The functions in this file are defined to Sort the CX of M_I_init by creasing, save the ID in Tab_Indices.
	The following function types are included:
	+ Classement_Zones(): Sort the CX of M_I_init by creasing, save the ID in Tab_Indices.
	+ Classement_Zones_LR(): Sort the CX of M_I_init between [Donnees->NB_INTERVALLES * Star, Donnees->NB_INTERVALLES * End] by creasing, save the ID in Tab_Indices
