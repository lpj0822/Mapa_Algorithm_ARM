...
Description:
	...
	+ Copie(): Copy M_I_new to M_I_est.
	+ Proba_Ok(): If the estimated proba of M_I_new satisfied  Donnees->Proba and Donnees->Proba_Bord return 1;else return 0.
