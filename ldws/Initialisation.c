...
Description:
	...
	The following static function types are included:
	+ Calcul_Ordonnees(): Init the values of M_I_init->V and M_I_est->V.
	+ Jacobien_Trip_Voie(): Calculation of the initial X coordinate of M_I_init->X and M_3D_init->X, Calculation the Jacobien.
